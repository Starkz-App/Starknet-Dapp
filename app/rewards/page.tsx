...
import { Zap, Trophy, ChevronRight, BookOpen, ThumbsUp } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-4xl font-bold">
                1,250 <span className="text-xl text-muted-foreground">STZ</span>
              </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Article Contributions</CardTitle>
                <BookOpen className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">350 STZ</div>
                <p className="text-xs text-muted-foreground">Earned from your articles</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Earned from likes and comments</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Community Building</CardTitle>
                <Trophy className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">620 STZ</div>
                <p className="text-xs text-muted-foreground">Earned from referrals and collaborations</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
