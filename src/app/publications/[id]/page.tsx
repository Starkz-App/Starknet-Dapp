...
export default function PublicationPage() {
  ...
  const handleCommentSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (newComment.trim() === '' || userCredits < 5) return
    ...
    toast({
      ...
      description: "Your comment has been added. 5 credits deducted.",
    })
  }
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <article className="space-y-8">
        ...
        <div className="aspect-video relative rounded-lg overflow-hidden shadow-lg">
          <Image
            src={`https://source.unsplash.com/random/1200x800?${publication.category}`}
        ...
        <div className="prose max-w-none bg-card text-card-foreground p-6 rounded-lg shadow-lg">
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleCommentSubmit} className="space-y-4">
                  <Textarea
                    placeholder="Add a comment... (5 credits)"
                    value={newComment}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button type="submit" disabled={userCredits < 5}>Post Comment</Button>
                  </div>
                </form>
        ...
        <section className="bg-primary text-primary-foreground rounded-lg p-6 space-y-6">
          <h2 className="text-2xl font-bold mb-4">Join Our Knowledge Sharing Community</h2>
          <div className="grid md:grid-cols-3 gap-4">
            <Card className="bg-background/10 backdrop-blur-sm text-primary-foreground">
              <CardHeader>
          ...
          <div className="flex justify-center mt-6">
            <Button size="lg" variant="secondary" asChild>
              <Link href="/signup">Join Now and Start Earning</Link>
            </Button>
          </div>
        </section>
      </article>
