...
import { mockNotifications, type Notification } from "@/lib/mockNotifications"
          ...
          <div className="flex items-center gap-1">
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full hover:bg-white/20 dark:hover:bg-black/20 relative"
                  title="Notifications"
                >
            ...
            <Sheet>
              ...
              <SheetContent className="overflow-y-auto">
                <SheetHeader>
                  <SheetTitle>{isLoggedIn ? "My Account" : "Sign In"}</SheetTitle>
                  <SheetDescription>
                    {isLoggedIn ? "Manage your account and preferences" : "Sign in or create a new account"}
                  </SheetDescription>
                </SheetHeader>
                <div className="mt-6">
